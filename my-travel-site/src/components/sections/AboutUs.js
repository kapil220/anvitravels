    ...
    <section id="about" className="py-20 bg-gray-200">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">About Our Travel Agency</h2>
          <div className="w-24 h-1 bg-blue-600 mx-auto"></div>
        </div>
        
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 mb-10 md:mb-0 md:pr-10">
            <h3 className="text-2xl font-semibold mb-4 text-gray-800">Creating Unforgettable Travel Experiences Since 2005</h3>
            <p className="text-gray-600 mb-6 leading-relaxed">
              At Wanderlust Travels, we believe in the transformative power of travel. For over 15 years, 
              weve been helping travelers discover the worlds most amazing destinations with carefully 
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            <div className="absolute bottom-4 right-4 bg-white p-4 rounded-lg shadow-lg md:max-w-xs">
              <p className="font-semibold text-gray-800">
                We dont just sell destinations, we create meaningful connections with places and people.
              </p>
              <p className="mt-2 text-blue-600 font-medium">— Sarah Johnson, Founder</p>
            </div>
          </div>
        </div>
      </div>
